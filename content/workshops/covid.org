...
Our side by side graphs don't make comparisons very easy since they vary greatly in their axes scales. Of course, we could constrain them to have the same axes, but then, why not plot multiple countries or provinces in the same graph?

#+ATTR_HTML: :alt plot :title Number of confirmed cases in a few countries
...
#+ATTR_HTML: :alt plot :title Number of deaths in a few countries
