...
Many text editors have plugins, extensions, or packages to turn them into IDEs for Julia. You can find the list on the [[https://julialang.org/][Julia website]]. Here are a few:
